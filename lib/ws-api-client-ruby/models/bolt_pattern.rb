...
module WsApiClient
  class BoltPattern
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stud')
        self.stud = attributes[:'stud']
      end
    ...
    def list_invalid_properties
      ...
      if @stud.nil?
        invalid_properties.push('invalid value for "stud", stud cannot be nil.')
      end
