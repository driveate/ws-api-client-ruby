...
module WsApiClient
  ...
  class TiresAggregation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'diameter')
      ...
      if attributes.has_key?(:'tire_size')
        self.tire_size = attributes[:'tire_size']
      end
    end
    ...
    def hash
      [aspect_ratio, diameter, width, tire_size].hash
    end
