...
# Unit tests for WsApiClient::VehiclesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VehiclesApi' do
  before do
    # run before each test
    @instance = WsApiClient::VehiclesApi.new
  end
  ...
  describe 'test an instance of VehiclesApi' do
    it 'should create an instance of VehiclesApi' do
      expect(@instance).to be_instance_of(WsApiClient::VehiclesApi)
    end
  end

  # unit tests for vehicles_list
