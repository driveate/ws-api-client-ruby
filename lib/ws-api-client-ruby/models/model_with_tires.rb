...
module WsApiClient
  class ModelWithTires
    ...
    def self.swagger_types
      {
        ...
        :'rims' => :'Hash<String, RimAgregation>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'years')
        if (value = attributes[:'years']).is_a?(Array)
          self.years = value
        end
      end

      if attributes.has_key?(:'generations')
        if (value = attributes[:'generations']).is_a?(Array)
          self.generations = value
        end
      end

      if attributes.has_key?(:'tires')
        self.tires = attributes[:'tires']
      end

      if attributes.has_key?(:'rims')
        if (value = attributes[:'rims']).is_a?(Hash)
          self.rims = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @generations.nil?
        invalid_properties.push('invalid value for "generations", generations cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @generations.nil?
      true
    end
    ...
    def hash
      [make, model, year, years, generations, tires, rims].hash
    end
